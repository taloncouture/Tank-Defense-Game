...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height, speed, reload_time, num_lives):
        ...
        tank_1 = pygame.image.load("data/tank_ice_1.png")
        tank_1 = pygame.transform.scale(tank_1, (width, height))
        tank_2 = pygame.image.load("data/tank_ice_2.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height, speed, type, shoot_delay, bullet_speed):
        ...
        if type == 'car':
            enemy_1 = pygame.image.load("data/car_1.png")
            enemy_1 = pygame.transform.scale(enemy_1, (width, height))
            enemy_2 = pygame.image.load("data/car_2.png")
        ...
        if type == 'tank':
            ...
            enemy_1 = pygame.image.load('data/enemy_1.png')
            enemy_1 = pygame.transform.scale(enemy_1, (width, height))
            enemy_2 = pygame.image.load('data/enemy_2.png')
            enemy_2 = pygame.transform.scale(enemy_2, (width, height))
            self.frames = [enemy_1, enemy_2]
            self.animation_index = 0
            self.image = self.frames[self.animation_index]
...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, x, y, width, height):
        ...
        obstacle = pygame.image.load("data/obstacle.png")
...
def reload_bar(reload_status, reload_time, width, height, x, y):
    reload_bar_1 = pygame.image.load("data/reload_bar_1.png")
    reload_bar_1 = pygame.transform.scale(reload_bar_1, (width, height))
    reload_bar_2 = pygame.image.load("data/reload_bar_2.png")
    reload_bar_2 = pygame.transform.scale(reload_bar_2, (width, height))
    reload_bar_3 = pygame.image.load("data/reload_bar_3.png")
    reload_bar_3 = pygame.transform.scale(reload_bar_3, (width, height))
    reload_bar_4 = pygame.image.load("data/reload_bar_4.png")
...
def lives(width, height, num_lives):
    ...
    icon = pygame.image.load("data/tank_icon_ice.png")
...
game_font = pygame.font.Font('data/8bitOperatorPlus8-Regular.ttf', 30)
small_game_font = pygame.font.Font('data/8bitOperatorPlus8-Bold.ttf', 15)
title_font = pygame.font.Font('data/8bitOperatorPlus8-Bold.ttf', 60)
score_font = pygame.font.Font('data/8bitOperatorPlus8-Regular.ttf', 40)

shoot_sound = pygame.mixer.Sound('data/tank_shoot.wav')
destroy_sound = pygame.mixer.Sound('data/hit.wav')
lost_life_sound = pygame.mixer.Sound('data/lost_life.wav')
click_sound = pygame.mixer.Sound('data/click.wav')
game_over_sound = pygame.mixer.Sound('data/game_over2.wav')
